...
import {
    ...
    PUSH_NOTI_WHEN_JOIN_COURSE_TYPE
} from "./../../util/ApplicationConstants";

module.exports = function process(queue){
    queue.process(PUSH_NOTI_WHEN_JOIN_COURSE_KUE, MAX_ACTIVE_JOBS, async function (job, done){
        ...
        let message = {
            data: {
                ...
                push_type: PUSH_NOTI_WHEN_JOIN_COURSE_TYPE
            },
            notification: {
        ...
        pushNotiService.pushNotification(sendTo, message, notificationId);
        done();
    });
};